...
> **Version:** v2.1 · reconciled against the real Flutter implementation
> **Reconciled:** 2026-05-31 — incorporates `PR3_DESIGN_RULINGS.md` (final)
...
- **Shadow:** two-layer forest shadow — `0 8px 20px rgba(15,61,46,.45)` (deep) +
  `0 2px 8px rgba(26,90,69,.20)` (mid). Same in dark mode.
  **blurRadius 20/8 is canonical as of 2026-06-01 sign-off. Do not restore 42/12.**
...
- iOS widget visuals (covered by `IOS_WIDGETS_SPEC.md`, must mirror this
  card's calm hierarchy 1:1).
