...
12. Component specs: `COMPONENT_SPECS.md`, `PRAYER_CARD_SPEC.md` (+ `PR3_DESIGN_RULINGS.md` — final PR3 decisions, read alongside the prayer-card spec), `CALENDAR_CELL_SPEC.md`, `ATHKAR_SPEC.md`, `IOS_WIDGETS_SPEC.md`, `STATS_KPI_SPEC.md`, `FOCUS_OIL_SPEC.md`, `CALENDAR_FOCUS_REDESIGN.md`, `ONBOARDING_AB_SPEC.md`.
...
├── COMPONENT_SPECS.md
├── PRAYER_CARD_SPEC.md
├── PR3_DESIGN_RULINGS.md          ← final PR3 decisions (6 blockers resolved)
...
| PR3 | Prayer card refresh — restyle only, per `PRAYER_CARD_SPEC.md` v2 (PR3 reconciled). Forest gradient + 44pt countdown + calm active state. Preserve `PrayerCubit` 40-min post-prayer window + Duha/Qiyam nafl logic. Reuse `UserSettings.prayerCardDisplayMode`; compact/expanded as widget-local state |
