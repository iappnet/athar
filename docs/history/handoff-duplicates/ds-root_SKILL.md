...
- **Cairo** for Arabic (and a perfectly fine Latin fallback). **Inter** for English-only contexts. **JetBrains Mono** for numerals when alignment matters (timer, counters, stats).
