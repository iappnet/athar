// TODO(DS-ATOMS): rename file to athar_button.dart once all callers have
// updated their import paths. The exported classes (AtharButton, AtharIconButton,
// AtharFAB) are the canonical implementations — no API change required.
  ...
  List<BoxShadow>? get _boxShadow {
    ...
    switch (widget.variant) {
      ...
      case AtharButtonVariant.danger:
        ...
        break;
      case AtharButtonVariant.success:
        shadowColor = context.colors.success;
        break;
      case AtharButtonVariant.warning:
        shadowColor = context.colors.warning;
        break;
      default:
        return null;
    }
