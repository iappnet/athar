...
/// ===================================================================
/// ATHAR LIGHT THEME - الثيم الفاتح
/// ===================================================================
/// ثيم الوضع الفاتح الكامل لتطبيق أثر
/// ===================================================================

class AtharLightTheme {
  AtharLightTheme._();

  /// ألوان الوضع الفاتح
  static const AtharColors colors = AtharColors.light;
  ...
  static ThemeData get theme {
    return ThemeData(
      ...
      // EXTENSIONS
      // ─────────────────────────────────────────────────────────────
      extensions: const <ThemeExtension<dynamic>>[AtharColors.light],
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        backgroundColor: colors.surface,
        surfaceTintColor: Colors.transparent,
        indicatorColor: colors.primaryLight.withValues(alpha: 0.3),
