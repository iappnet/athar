...
extension FocusSessionQueryWhereSort
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension FocusSessionQueryWhere
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> dateGreaterThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> dateLessThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> dateBetween(
    DateTime lowerDate,
    DateTime upperDate, {
    bool includeLower = true,
    bool includeUpper = true,
