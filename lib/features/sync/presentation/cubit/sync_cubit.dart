...
import 'package:internet_connection_checker_plus/internet_connection_checker_plus.dart'; // ✅ لفحص النت
import 'package:supabase_flutter/supabase_flutter.dart'; // ✅ لفحص المستخدم
import 'package:athar/features/settings/domain/repositories/settings_repository.dart'; // ✅ لفحص الإعدادات
...
class SyncCubit extends Cubit<SyncState> {
  ...
  Future<void> triggerSync({bool isManual = false}) async {
    ...
    // 🛑 2. الحارس الثاني: التحقق من الإعدادات (للمزامنة التلقائية فقط)
    ...
    // 🛑 3. الحارس الثالث: التحقق من الإنترنت (Real Connectivity Check)
